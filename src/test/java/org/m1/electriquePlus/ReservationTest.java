...
public class ReservationTest {
    ...
    public void testReservationSuccess() {
        ...
        client = new Client("test","testeur",a,6460428820L,"email@email.email","1234123412341234",vehicule);
        dateTimeDebut = LocalDateTime.of(2024, 05, 28, 10, 0);
    ...
    public void testReservationFailureDueToUnavailability() {
        ...
        client = new Client("test","testeur",adresse,6460428820L,"email@email.email","1234123412341234",vehicule);
        ...
        Client client2 = new Client("test2","testeur2",adresse2,1234567890L,"email2@email.email","1234123412341234",vehicule2);
