...
public class BorneTest {
    ...
    public void testChangeStatusBorne(){
        ...
        assertThat(borne1.changeStatusBorne("02/08", "05", "OCCUPE")).isEqualTo(0);
        assertThat(borne1.checkDisponibilites("02/08", "05")).isEqualTo('O');
    }
    ...
    public void testChangeStatusBorneFail(){
        ...
        assertThat(borne1.changeStatusBorne("02/08", "05", "PAS DISPONIBLE")).isEqualTo(1);
        assertThat(borne1.checkDisponibilites("02/08", "05")).isEqualTo('D');
    }
